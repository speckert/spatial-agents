...
@router.get("/info/{h3_cell}")
async def tile_info(h3_cell: str) -> dict[str, Any]:
    """Return metadata about an H3 cell — center, boundary, resolution."""
...
@router.get("/stats")
async def tile_stats() -> dict[str, Any]:
    """Return statistics about generated tiles on disk."""
    return _builder.tile_stats()
...
async def cell_for_position(
    ...
    """Return H3 cell IDs at all resolutions for a given position."""
